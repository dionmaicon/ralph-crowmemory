...
8. Update `CLAUDE.md` files with reusable patterns if discovered (see below).
...
Before storing progress, check if any edited files have learnings worth preserving in nearby `CLAUDE.md` files:
